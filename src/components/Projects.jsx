    ...
    <>
      ...
      >
        <div className="col-span-1 flex justify-center md:justify-end md:pr-16 md:col-span-3">
          <div className="relative sm:sticky sm:top-20 h-max">
                  ...
                  <div className="relative  overflow-hidden rounded-lg shadow-lg shadow-black/30 lg:shadow-xl">
                    ...
                    >
                      <div className="relative h-full w-full p-4">
                        ...
                        <FaLink className="absolute bottom-1 right-1 h-4 w-4 shrink-0  sm:bottom-2 sm:right-2" />
                      </div>
                    </a>
                  </div>
                  {project.ghLink && (
                    <a
                      href={project.ghLink}
                      target="_blank"
                      className="hover:text-orange-500 duration-300 mt-1 flex items-center gap-2"
                    >
                      Repository Link
                      <FaLink className=" h-4 w-4 shrink-0  sm:bottom-2 sm:right-2" />
                    </a>
                  )}
                </div>
              ))}
