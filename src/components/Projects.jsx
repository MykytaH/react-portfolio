...
export default function Projects() {
  return (
    <>
      <div
        className="h-auto  pt-20 grid grid-cols-1 gap-y-4 py-8 first:pt-0 last:pb-0  md:grid-cols-8 "
        id={"projects"}
      >
        <div className="col-span-1 flex justify-center md:justify-end md:pr-16 md:col-span-2">
